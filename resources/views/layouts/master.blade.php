					...
					<div class="col-sm-5">
						<form action="{{ URL::to('search') }}" method="POST">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" style="margin-top: 0" class="btn btn-primary btn-sm" value="Tìm kiếm">
							</div>
						</form>
					</div>
				</div>
                        ...
                        <div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="{{ URL::to('brand/'.$item->brand_id) }}"> <span class="pull-right">(50)</span>{{ $item->brand_name }}</a></li>
                                </ul>
                            </div>
							@endforeach
